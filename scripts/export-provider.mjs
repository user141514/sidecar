...
export const providerFiles = [
  ...
  'src/send-mailbox.mjs', 'src/conversation-contract.mjs',
  'test/send-mailbox.test.mjs', 'test/mailbox-browser-guard.test.mjs', 'test/conversation-contract.test.mjs', 'test/fixtures/conversation-runtime-v1.json',
